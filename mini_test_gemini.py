...
try:
    ...
    print(f"ERROR: Could not import Gemini module: {e}")
    sys.exit(1)
except Exception as e:
    print(f"ERROR: An unexpected error occurred when importing Gemini module: {e}")
    traceback.print_exc()
    sys.exit(1)
...
def test_gemini():
    ...
    # Save results
    results_file = 'mini_test_results/mini_results_gemini.csv'
    ...
    summary_file = 'mini_test_results/mini_summary_gemini.csv'
