...
def test_claude():
    ...
    for i, row in ocr_df.iterrows():
        ...
        try:
            ...
            product_details_json = get_product_details_claude(ocr_text)
            end_time = time.time()
            ...
            start_time = time.time()
            matching_products_json = get_matching_products_claude(product_name, expiration_date, top_n, existing_products_df)
            end_time = time.time()
    ...
    # Save results
    results_file = 'mini_test_results/mini_results_claude.csv'
    ...
    summary_file = 'mini_test_results/mini_summary_claude.csv'
